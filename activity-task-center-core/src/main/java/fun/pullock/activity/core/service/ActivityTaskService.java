package fun.pullock.activity.core.service;

import fun.pullock.activity.core.manager.ActivityEventManager;
import fun.pullock.activity.core.manager.ActivityTaskManager;
import fun.pullock.activity.core.manager.ActivityUserTaskManager;
...
import fun.pullock.activity.core.strategy.task.task.TaskTypeHandler;
...
import fun.pullock.activity.core.strategy.task.task.TaskTypeHandlerFactory;
